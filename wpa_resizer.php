...
// WPA Resizer v1.0
// Based on: article on http://veryraw.com/

// OC Improvements
//    - Now works with subdomains
...
// 09/04/2010 - handle subdomains
if (!isset($_SERVER['SUBDOMAIN_DOCUMENT_ROOT'])) {
   $document_root = $_SERVER['DOCUMENT_ROOT']; 
} else {
   $document_root = $_SERVER['SUBDOMAIN_DOCUMENT_ROOT']; 
}
...
// only perform this is we have php 5.0
